...
import com.example.pharmkare.databinding.ActivityAccountRecoveryBinding
            ...
            Firebase.auth.sendPasswordResetEmail(emailAddress)
                .addOnCompleteListener { task->
                    if (task.isSuccessful){
                        ...
                        Toast.makeText(baseContext, "Ingrese un correo electronico valido.",Toast.LENGTH_SHORT).show()
                    }
                }
        }
