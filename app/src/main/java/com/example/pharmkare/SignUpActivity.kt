...
import com.example.pharmkare.databinding.ActivitySignUpBinding
        ...
        auth.createUserWithEmailAndPassword(email, password)
            .addOnCompleteListener(this) { task ->
                if (task.isSuccessful) {
                    ...
                    Toast.makeText(this, "No se pudo crear la cuenta. Por favor intentalo nuevamente.", Toast.LENGTH_SHORT).show()
                }
            }
    }
}